...
export interface OrderWithShippingMethods extends Omit<OrderResponse, 'token' | 'shipping_rate'> {
    shipping_methods: ShippingMethod[];
}
export declare type OrderResponseWithoutToken = Omit<OrderResponse, 'token'>;
